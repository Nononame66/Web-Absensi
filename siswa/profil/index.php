...
<head>
    ...
    <title>Profil Siswa - SMKN 1 Sanden</title>    
                        ...
                        <div class="p-4 sm:p-6 text-center">
                            ...
                            <div class="space-y-3 mt-4">
                                <div class="flex items-center justify-center text-gray-300">
                                    <i class="fas fa-id-card text-teal-300 mr-2"></i>
                        ...
                        <form method="POST" enctype="multipart/form-data" class="mobile-form-spacing">
                            <div class="mb-4">
                                ...
                                <input type="text" id="nama_lengkap" name="nama_lengkap"
                                    ...
                                    class="w-full px-3 lg:px-4 py-2.5 rounded-lg bg-gray-800/50 border border-gray-700 text-white focus:outline-none focus:border-teal-400 mobile-touch-target">
                            </div>
                            ...
                            <div class="flex justify-end">
                                <button type="submit" name="update_profile"
                                    class="px-6 py-2.5 bg-teal-500 hover:bg-teal-600 rounded-lg font-medium text-white 
