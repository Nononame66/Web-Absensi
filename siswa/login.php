...
<head>
    ...
    <title>Login Siswa - SMKN 1 Sanden</title>
    ...
    <style>
        ...
        .animated-gradient {
            background: linear-gradient(-45deg, #6941c6, #14b8a6, #4338ca, #7e22ce);
...
<body class="bg-gray-900 min-h-screen flex items-center justify-center">
    ...
    <div class="fixed inset-0 bg-gradient-to-br from-indigo-900/50 to-teal-500/40 pointer-events-none"></div>
    ...
    <div class="max-w-md w-full mx-4 relative z-10">
        ...
        <!-- Login Form -->
        <div class="glass-effect rounded-2xl shadow-2xl p-8 border border-teal-500/30 shadow-teal-500/10">
            <?php if ($error): ?>
            ...
            <form method="POST" class="space-y-6">
                <div>
                    <label class="block text-gray-300 text-sm font-medium mb-2">
                        <i class="fas fa-id-card text-teal-400 mr-2"></i>NIS
                    </label>
                    <div class="relative">
                        <input type="text" name="nis"
                            class="w-full px-4 py-3 rounded-lg bg-gray-800/80 border border-teal-500/30 text-white 
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <button type="button" onclick="togglePassword()"
                            class="absolute right-4 top-1/2 transform -translate-y-1/2 text-gray-400 hover:text-teal-300 focus:outline-none">
                ...
                <button type="submit"
                    ...
                    focus:outline-none focus:ring-2 focus:ring-teal-500/30 flex items-center justify-center
        ...
        <div class="text-center mt-4">
            <a href="../admin/login.php" class="text-xs text-teal-300 hover:text-purple-300 transition-colors flex items-center justify-center">
