...
<head>
    ...
    <title>Riwayat Absensi - SMKN 1 Sanden</title>    
        ...
        <div class="p-4 lg:p-8">
            <div class="max-w-6xl mx-auto">
                ...
                <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 lg:gap-4 mb-6">
                    ...
                    <!-- Permission Card -->
                    <div class="glass-effect rounded-lg p-4 border-l-4 border-teal-400">
                        <h3 class="text-xs uppercase text-gray-400 font-medium mb-1">Izin</h3>
                        <p class="text-2xl font-bold"><?= $attendance_summary['izin'] ?></p>
                        <div class="mt-2 flex items-center">
                            <div class="w-full bg-gray-700 rounded-full h-1.5">
                                <div class="bg-teal-400 h-1.5 rounded-full" style="width: <?= $attendance_summary['total'] > 0 ? ($attendance_summary['izin'] / $attendance_summary['total'] * 100) : 0 ?>%"></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="glass-effect p-4 rounded-lg mb-6">
                    <form action="" method="GET" class="flex flex-wrap items-end gap-4 filter-container">
                        <div class="w-full sm:w-auto">
                            ...
                            <select id="month" name="month" class="w-full sm:w-auto bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:border-teal-400">
                                <?php for ($i = 1; $i <= 12; $i++) : ?>
                        ...
                        <div class="w-full sm:w-auto">
                            ...
                            <select id="year" name="year" class="w-full sm:w-auto bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:border-teal-400">
                                <?php
                                $currentYear = date('Y');
                        ...
                        <div class="w-full sm:w-auto">
                            ...
                            <select id="status" name="status" class="w-full sm:w-auto bg-gray-800 border border-gray-700 text-white rounded-lg px-3 py-2 focus:outline-none focus:border-teal-400">
                        ...
                        <div class="w-full sm:w-auto ml-auto mt-2 sm:mt-0">
                            <button type="submit" class="w-full sm:w-auto bg-teal-500 hover:bg-teal-600 text-white px-4 py-2 rounded-lg transition-colors flex items-center justify-center gap-2">
                                        ...
                                        <tr class="border-b border-gray-800 hover:bg-gray-900/20">
                                            ...
                                            <td class="p-4 text-sm">
                                                <?php if (!empty($record['bukti_foto'])) : ?>
                                                    <a href="#" onclick="showImagePreview('../../<?= $record['bukti_foto'] ?>')" class="text-teal-300 hover:text-purple-300 flex items-center gap-1">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                    ...
                    <div class="glass-effect rounded-lg overflow-hidden flex flex-col">
                        <div class="bg-gradient-to-r from-teal-500/30 to-indigo-900/40 p-4 border-b border-gray-800">
                            <h3 class="font-semibold flex items-center">
                                <i class="fas fa-lightbulb text-teal-400 mr-2"></i>
                                Statistik & Insight
                            </h3>
                        </div>
                        <div class="p-4 overflow-y-auto custom-scrollbar" style="max-height: 460px;">
                            ...
                            <div class="mb-4">
                                ...
                                <div class="h-2.5 bg-gray-700 rounded-full overflow-hidden">
                                    <div class="h-full bg-gradient-to-r from-teal-500 to-indigo-500 rounded-full"
                            ...
                            <div class="space-y-3">
                                <div class="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                                    <div class="flex items-center">
                                        <div class="h-8 w-8 rounded-md bg-teal-500/20 flex items-center justify-center mr-3">
                                            <i class="fas fa-medal text-teal-300"></i>
                                        </div>
                                ...
                                <div class="flex items-center justify-between p-3 bg-gray-800/50 rounded-lg">
                                    <div class="flex items-center">
                                        <div class="h-8 w-8 rounded-md bg-teal-500/20 flex items-center justify-center mr-3">
                                            <i class="fas fa-history text-teal-300"></i>
                                        </div>
