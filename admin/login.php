...
<head>
    ...
    <title>Login Admin - SMKN 1 Sanden</title>
...
<body class="bg-gray-900 min-h-screen flex items-center justify-center bg-[url('../assets/default/bg-pattern.png')] bg-repeat">
    ...
    <div class="fixed inset-0 bg-gradient-to-br from-teal-500/40 to-gray-900/50 pointer-events-none"></div>

    <div class="max-w-md w-full mx-4 relative z-10">
        <!-- Logo & Title -->
        <div class="text-center mb-8">
            <img src="../assets/default/smkn1sanden.png" alt="SMKN 1 Sanden"
                class="h-24 mx-auto mb-4 drop-shadow-[0_0_15px_rgba(147,51,234,0.5)]">
            <h2 class="text-3xl font-bold text-white mb-2 text-transparent bg-clip-text bg-gradient-to-r from-teal-300 to-teal-500">
                Login Admin
            </h2>
            <p class="text-gray-400">Sistem Absensi SMKN 1 Sanden</p>
        </div>

        <!-- Login Form -->
        <div class="glass-effect rounded-xl shadow-2xl p-8 shadow-teal-500/10">
            <?php if ($error): ?>
            ...
            <form method="POST" class="space-y-6">
                <div class="space-y-4">
                    <div class="group">
                        <label class="text-gray-300 text-sm font-medium mb-2 block opacity-90">
                            <i class="fas fa-user text-teal-400 mr-2"></i>Username
                        </label>
                        <input type="text" name="username" required
                            class="w-full px-5 py-4 rounded-lg bg-gray-800/80 border border-teal-500/30 text-white 
                    ...
                    <div class="group">
                        <label class="text-gray-300 text-sm font-medium mb-2 block opacity-90">
                            <i class="fas fa-lock text-teal-400 mr-2"></i>Password
                        </label>
                        <div class="relative">
                            ...
                            <button type="button" onclick="togglePassword()"
                                class="absolute right-4 top-1/2 -translate-y-1/2 text-gray-400 hover:text-teal-400
                ...
                <button type="submit"
                    class="w-full bg-gradient-to-r from-teal-500 to-purple-800 text-white font-medium py-4 px-4 
                    rounded-lg transition duration-300 hover:opacity-90 transform hover:-translate-y-0.5
                    focus:outline-none focus:ring-2 focus:ring-teal-500/20 flex items-center justify-center
