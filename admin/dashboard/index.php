...
foreach ($stats as $status => $count) {
    if (isset($yesterday_stats[$status]) && $yesterday_stats[$status] > 0) {
...
<head>
    ...
    <title>Dashboard Admin - SMKN 1 Sanden</title>
...
<body class="min-h-screen text-white bg-fixed">
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-screen w-64 glass-effect border-r border-teal-500/20 z-50 sidebar-transition -translate-x-full lg:translate-x-0">
        ...
        <nav class="p-4 space-y-2 overflow-y-auto no-scrollbar" style="max-height: calc(100vh - 76px);">
            ...
            <a href="../profil/" class="flex items-center gap-3 text-gray-400 p-3 rounded-lg hover:bg-teal-400/10 transition-colors">
    ...
    <!-- Main Content -->
    <main class="lg:ml-64 min-h-screen bg-transparent">
        <!-- Mobile Header -->
        <div class="lg:hidden bg-gray-900/60 backdrop-blur-lg sticky top-0 z-30 px-4 py-3 flex items-center justify-between border-b border-teal-500/20">
            ...
            <div class="flex items-center gap-3">
                ...
                <img src="../../<?= $_SESSION['admin_photo'] ?: '../../assets/default/photo-profile.png' ?>"
                    alt="Admin" class="h-8 w-8 rounded-full object-cover border border-teal-500/30">
            </div>
        </div>
        ...
        <div class="p-4 md:p-8">
            <div class="max-w-7xl mx-auto">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="relative hidden lg:block">
                            <button onclick="toggleNotifications()"
                                class="px-4 py-2 rounded-lg glass-effect hover:bg-teal-400/10 transition-colors">
                                <i class="fas fa-bell text-teal-400"></i>
                                <?php if (count($notifications) > 0): ?>
                                    <span class="absolute -top-1 -right-1 bg-red-500 text-white text-xs rounded-full h-5 w-5 flex items-center justify-center notification-counter">
                                        <?= count($notifications) ?>
                ...
                <div id="notificationPanel"
                    ...
                    <div class="p-4 border-b border-teal-500/20 flex justify-between items-center">
                    ...
                    <div id="notificationList" class="max-h-[60vh] lg:max-h-[480px] overflow-y-auto custom-scrollbar">
                        <?php if (count($notifications) > 0): ?>
                            <?php foreach ($notifications as $notif): ?>
                                <div class="p-4 border-b border-teal-500/20 hover:bg-teal-400/5 transition-colors notification-item"
                                        ...
                                        <div class="flex-1">
                                            ...
                                            <p class="text-sm text-gray-400 mt-0.5">
                                                ...
                                                <span class="text-gray-500">
                                                    • <?= $notif['created_at'] ? date('H:i', strtotime($notif['created_at'])) : '-' ?>
                                                </span>
                                            </p>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6 mb-6 md:mb-8">
                    <!-- Hadir Card -->
                    <div class="glass-effect rounded-xl p-4 md:p-6 hover:bg-teal-500/5 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-green-800/10 cursor-pointer" data-stat="hadir">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-gray-400 text-sm font-medium mb-1">Total Hadir</p>
                                <h3 class="text-3xl font-mono text-white tracking-wider stat-value drop-shadow-md"><?= $stats['hadir'] ?></h3>
                            </div>
                    ...
                    <!-- Sakit Card -->
                    <div class="glass-effect rounded-xl p-4 md:p-6 hover:bg-teal-500/5 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-yellow-800/10 cursor-pointer" data-stat="sakit">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-gray-400 text-sm font-medium mb-1">Total Sakit</p>
                                <h3 class="text-3xl font-mono text-white tracking-wider stat-value drop-shadow-md"><?= $stats['sakit'] ?></h3>
                            </div>
                    ...
                    <!-- Izin Card -->
                    <div class="glass-effect rounded-xl p-4 md:p-6 hover:bg-teal-500/5 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-teal-800/20 cursor-pointer" data-stat="izin">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-gray-400 text-sm font-medium mb-1">Total Izin</p>
                                <h3 class="text-3xl font-mono text-white tracking-wider stat-value drop-shadow-md"><?= $stats['izin'] ?></h3>
                            </div>
                            <div class="h-10 w-10 md:h-12 md:w-12 rounded-xl bg-gradient-to-br from-teal-400/30 to-purple-700/30 flex items-center justify-center shadow-md">
                                <i class="fas fa-clipboard-list text-teal-300 text-lg"></i>
                            </div>
                        </div>
                        <div class="mt-3 md:mt-4 text-sm stat-change">
                    ...
                    <!-- Terlambat Card -->
                    <div class="glass-effect rounded-xl p-4 md:p-6 hover:bg-teal-500/5 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-orange-800/10 cursor-pointer" data-stat="terlambat">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-gray-400 text-sm font-medium mb-1">Total Terlambat</p>
                                <h3 class="text-3xl font-mono text-white tracking-wider stat-value drop-shadow-md"><?= $stats['terlambat'] ?></h3>
                            </div>
                    ...
                    <!-- Alpha Card -->
                    <div class="glass-effect rounded-xl p-4 md:p-6 hover:bg-teal-500/5 transition-all duration-300 transform hover:scale-[1.02] hover:shadow-lg hover:shadow-red-800/10 cursor-pointer" data-stat="alpha">
                        <div class="flex justify-between items-start">
                            <div>
                                <p class="text-gray-400 text-sm font-medium mb-1">Total Alpha</p>
                                <h3 class="text-3xl font-mono text-white tracking-wider stat-value drop-shadow-md"><?= $stats['alpha'] ?></h3>
                            </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div class="glass-effect rounded-xl overflow-hidden">
                        <div class="bg-gradient-to-r bg-[#18181b] p-4 border-b border-[#2dd4bf]/20">
                            <h3 class="text-lg font-semibold flex items-center">
                                <i class="fas fa-history text-teal-300 mr-2"></i>
                                Aktivitas Terkini
                            </h3>
                        </div>
                        ...
                        <div class="divide-y divide-gray-800/50 max-h-[300px] md:max-h-[440px] overflow-y-auto custom-scrollbar">
                            <?php foreach ($activities as $index => $activity): ?>
                                <div class="p-4 hover:bg-teal-400/5 transition-colors">
                                    <div class="flex gap-3">
                                        <!-- User Avatar with Activity Type Indicator -->
                                        <div class="shrink-0">
                                            <div class="relative">
                                                <img src="../../<?= $activity['user_photo'] ?>" alt="User"
                                                    class="h-10 w-10 rounded-full object-cover border-2 border-teal-400/20 shadow-md">
                                                <?php
                                                $activityTypeIcons = [
                                                    ...
                                                    'approval' => 'fa-check-circle bg-teal-400/20 text-teal-300',
                                                ];
                                        ...
                                        <div class="flex-1">
                                            <div class="flex items-start justify-between">
                                                ...
                                                <?php if ($index === 0): ?>
                                                    <span class="px-1.5 py-0.5 bg-teal-400/20 text-teal-300 text-xs rounded border border-teal-400/20 ml-2 shrink-0">
                                                        Baru
                                                    </span>
                                                <?php endif; ?>
                                            </div>
                                            ...
                                            <div class="flex justify-between items-center mt-2">
                                                <p class="text-teal-300 text-xs font-medium"><?= htmlspecialchars($activity['user_name']) ?></p>
                ...
                <div class="mt-6">
                    <h3 class="text-lg font-semibold mb-4 flex items-center">
                        <i class="fas fa-chart-bar text-teal-400 mr-2"></i>
                        Statistik Bulanan
                    </h3>
                    ...
                    const monthlyConfig = {
                        ...
                        data: {
                            ...
                            datasets: [{
                                label: 'Kehadiran',
                                data: data,
                                backgroundColor: 'rgba(20, 184, 166, 0.2)', // Purple theme
    ...
    <!-- Theme Toggle Inline Handler (Fallback) -->
    <script>
        // Global toggle function as fallback
