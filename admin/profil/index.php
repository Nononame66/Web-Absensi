...
<head>
    ...
    <title>Profil Admin - SMKN 1 Sanden</title>    
    ...
    <aside id="sidebar" class="fixed top-0 left-0 h-screen w-64 glass-effect border-r border-teal-500/20 z-50 sidebar-transition -translate-x-full lg:translate-x-0">
        ...
        <nav class="p-4 space-y-2 overflow-y-auto no-scrollbar" style="max-height: calc(100vh - 80px);">
            ...
            <a href="index.php" class="flex items-center gap-3 text-white/90 p-3 rounded-lg menu-active">
                <i class="fas fa-user-cog text-teal-400"></i>
                <span>Profil</span>
            </a>
        ...
        <div class="p-4 lg:p-8">
            <div class="max-w-4xl mx-auto">
                <h1 class="text-xl lg:text-2xl font-bold mb-4 lg:mb-6 flex items-center">
                    <i class="fas fa-user-circle text-teal-400 mr-3 hidden sm:inline"></i>
                    Profil Admin
                </h1>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 lg:gap-6">
                    ...
                    <div class="glass-effect rounded-xl overflow-hidden">
                        ...
                        <div class="bg-gradient-to-r from-teal-500/40 to-indigo-900/50 p-6 relative">
                            ...
                            <div class="absolute top-0 left-0 w-full h-full opacity-20 hidden sm:block">
                                ...
                                <div class="absolute top-1/2 right-4 w-8 h-8 rounded-full bg-teal-500/20"></div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 sm:p-6 text-center">
                            ...
                            <p class="inline-block px-3 py-1 bg-teal-500/10 text-teal-300 rounded-full text-xs font-medium mb-3">
                                Administrator
                            </p>

                            <div class="space-y-3 mt-4">
                                <div class="flex items-center justify-center text-gray-300">
                                    <i class="fas fa-user-circle text-teal-300 mr-2"></i>
                                    <span><?= htmlspecialchars($admin['username']) ?></span>
                                </div>

                                <div class="flex items-center justify-center text-gray-300">
                                    <i class="fas fa-envelope text-teal-300 mr-2"></i>
                                    <span class="text-sm break-all"><?= htmlspecialchars($admin['email']) ?></span>
                                </div>

                                <div class="pt-4 mt-4 border-t border-[#2dd4bf]/20">
                                    <div class="flex items-center justify-center text-gray-400">
                                        <i class="fas fa-clock text-teal-300 mr-2"></i>
                                        <span class="text-sm">
                                            Terakhir login:<br>
                            ...
                            <div class="mt-6">
                                <button type="button" onclick="document.getElementById('foto').click();"
                                    class="px-4 py-2.5 bg-teal-500/30 hover:bg-teal-500/50 rounded-lg text-sm 
                        ...
                        <!-- Account Stats -->
                        <div class="grid grid-cols-2 divide-x divide-gray-800/50 border-t border-[#2dd4bf]/20">
                    ...
                    <div class="glass-effect rounded-xl p-4 lg:p-6 lg:col-span-2 form-container">
                        <h3 class="font-semibold text-lg mb-4 flex items-center">
                            <i class="fas fa-user-edit text-teal-400 mr-2"></i>
                            Edit Profil
                        </h3>
                        <form method="POST" enctype="multipart/form-data" class="mobile-form-spacing">
                            <div class="mb-4">
                                ...
                                <input type="text" id="username" name="username" value="<?= htmlspecialchars($admin['username']) ?>" required
                                    class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-2.5 text-white focus:outline-none focus:border-teal-400 mobile-touch-target">
                            </div>
                                ...
                                <div class="file-input-container flex">
                                    <div class="relative flex-grow">
                                        ...
                                        <div class="absolute inset-y-0 bottom-2 right-0 flex items-center">
                                            <button type="button" onclick="document.getElementById('foto').click();"
                                                class="h-full px-3 bg-teal-500 hover:bg-teal-600 rounded-r-lg text-white text-sm transition-colors">
                                                Browse
                                            </button>
                                        </div>
                                    </div>
                            ...
                            <div class="flex justify-end">
                                <button type="submit" name="update_profile" class="px-6 py-2.5 bg-teal-500 hover:bg-teal-600 rounded-lg font-medium text-white transition-colors mobile-touch-target btn-hover-effect">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <input type="password" id="current_password" name="current_password" required
                                        class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-2.5 text-white focus:outline-none focus:border-teal-400 pr-10 mobile-touch-target">
