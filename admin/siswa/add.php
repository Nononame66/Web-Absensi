...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    try {
        ...
        if (isset($_FILES['foto_profil']) && $_FILES['foto_profil']['error'] === 0) {
            ...
            $clean_nis = preg_replace('/[^a-zA-Z0-9]/', '', $nis);
            $filename = 'profile_' . $clean_nis . '_' . time() . '.' . $file_extension;
        ...
        // Insert student data
        $sql = "INSERT INTO siswa (nis, nama_lengkap, jenis_kelamin, kelas, jurusan, email, password, foto_profil) 
                VALUES (:nis, :nama_lengkap, :jenis_kelamin, :kelas, :jurusan, :email, :password, :foto_profil)";
...
<head>
    ...
    <title>Tambah Siswa - SMKN 1 Sanden</title>    
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6 text-center">
                            <div class="relative w-28 h-28 md:w-32 md:h-32 mx-auto">
                                ...
                                <label for="foto_profil" class="absolute -bottom-2 -right-2 bg-teal-500 hover:bg-teal-600 rounded-full w-9 h-9 md:w-10 md:h-10 flex items-center justify-center cursor-pointer transition-colors profile-upload">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
                            ...
                            <div class="mb-2 md:mb-0">
                                ...
                                <input type="text" id="nis" name="nis" required
                                    class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 md:py-2 text-white focus:outline-none focus:border-teal-400 touch-target"
                            ...
                            <!-- Jenis Kelamin -->
                            <div class="mb-2 md:mb-0">
                                <label for="jenis_kelamin" class="block text-sm text-gray-400 mb-2">Jenis Kelamin</label>
                            ...
                            <div class="mb-2 md:mb-0">
                                ...
                                <div class="relative">
                                    <input type="password" id="password" name="password"
                                        ...
                                        class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 md:py-2 pr-10 text-white focus:outline-none focus:border-teal-400 touch-target">
                        ...
                        <div class="flex justify-end mt-6 md:mt-8">
                            <button type="submit" class="w-full md:w-auto px-6 py-3 md:py-2 bg-teal-500 hover:bg-teal-600 text-white rounded-lg transition-colors font-medium">
