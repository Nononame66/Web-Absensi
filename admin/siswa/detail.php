...
<head>
    ...
    <title>Detail Siswa - SMKN 1 Sanden</title>    
            ...
            <div class="max-w-7xl mx-auto">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6 mb-6">
                    ...
                    <div class="glass-effect rounded-xl overflow-hidden">
                        ...
                        <div class="h-24 sm:h-32 bg-gradient-to-r from-teal-500/30 to-blue-600/30 relative"></div>
                        ...
                        <div class="px-4 sm:px-6 pb-5 sm:pb-6 -mt-12 sm:-mt-14 relative">
                            ...
                            <p class="text-sm text-gray-400 mb-3 sm:mb-4"><?= $siswa['nis'] ?> • <?= $siswa['jenis_kelamin'] === 'L' ? 'Laki-Laki' : 'Perempuan' ?> • Kelas <?= $siswa['kelas'] ?> <?= $siswa['jurusan'] ?></p>

                            <!-- Contact info -->
                            <div class="space-y-2 sm:space-y-3">
                                <div class="flex items-center gap-3">
                                    <i class="fas fa-envelope w-5 text-center text-teal-400"></i>
                                    <span class="text-sm break-all"><?= htmlspecialchars($siswa['email']) ?></span>
                                </div>
                                <div class="flex items-center gap-3">
                                    <i class="fas fa-clock w-5 text-center text-teal-400"></i>
                                ...
                                <?php foreach ($recent_absensi as $absensi): ?>
                                    <a href="../absensi/detail.php?id=<?= $absensi['id'] ?>"
                                        ...
                                        <div class="flex justify-between items-start">
                                            <div>
                                                <p class="text-sm font-medium"><?= $absensi['tanggal'] ? date('d/m/Y', strtotime($absensi['tanggal'])) : '-' ?></p>
