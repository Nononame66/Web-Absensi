...
<head>
    ...
    <title>Edit Absensi - SMKN 1 Sanden</title>    
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6 mb-6">
                            ...
                            <div>
                                ...
                                <select id="status" name="status" required onchange="toggleTimeVisibility()"
                                    class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 md:py-2 text-white focus:outline-none focus:border-teal-400 touch-target">
                                    <option value="Menunggu" <?= $absensi['status'] == 'Menunggu' ? 'selected' : '' ?>>Menunggu (Perlu Ditinjau)</option>
                        ...
                        <div class="mb-6">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3"
                                class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 text-white focus:outline-none focus:border-teal-400 touch-target"><?= htmlspecialchars($absensi['keterangan']) ?></textarea>
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="relative">
                                ...
                                <button type="button" onclick="document.getElementById('bukti_file').click()"
                                    class="absolute right-2 top-1/2 -translate-y-1/2 px-3 py-1 bg-teal-500/80 hover:bg-teal-500 rounded text-sm">
                                    Browse
                                </button>
                            </div>
