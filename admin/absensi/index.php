...
<head>
    ...
    <title>Data Absensi - SMKN 1 Sanden</title>    
                    ...
                    <form method="GET" id="filterForm">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-6 gap-y-4">
                            <div>
                                ...
                                <div class="relative">
                                    <input type="date" name="date" value="<?= $date_filter ?>"
                                        class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-teal-400">
                                    <?php if ($date_filter): ?>
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="status" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-teal-400">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    <select name="approval" class="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-sm text-white focus:outline-none focus:border-teal-400">
                                        <option value="">Semua Status</option>
