...
<head>
    ...
    <title>Tambah Absensi - SMKN 1 Sanden</title>    
                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-6">
                            ...
                            <div class="mt-2 lg:hidden">
                                <input type="text" id="studentSearch" placeholder="Cari siswa..."
                                    class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 text-white focus:outline-none focus:border-teal-400">
                            </div>
                        </div>
                        ...
                        <div class="my-6">
                            ...
                            <textarea id="keterangan" name="keterangan" rows="3" placeholder="Masukkan keterangan atau alasan jika diperlukan"
                                class="w-full bg-gray-800/50 border border-gray-700 rounded-lg px-3 py-3 text-white focus:outline-none focus:border-teal-400"></textarea>
                        </div>
